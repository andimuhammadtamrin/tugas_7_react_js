    ...
    <Row>
      <Col>
        <Card style={{width:"250px"}}>
          ...
          <Card.Body>
            ...
            <Card.Text>
              Godin sekarang menjadi pemain Urugay dengan caps terbanyak setelah membantu
      ...
      <Card style={{width:"250px"}}>
        ...
        <Card.Body>
          ...
          <Card.Text>
            ...
            Neymar sedang berdiskusi dengan Paris Saint-Germain soal perpanjangan
      ...
      <Card style={{width:"250px"}}>
        ...
        <Card.Body>
          ...
          <Card.Text>
            ...
            untuk bisa menjadi tim terbaik di dunia dengan banyaknya talenta yang muncul sekarang
            ini
          </Card.Text>
          <Button variant="primary">Read More</Button>
        </Card.Body>
      ...
      <Card style={{width:"250px"}}>
        ...
        <Card.Body>
          ...
          <Card.Title>Mental Pemain Timnas Indonesia U-23 Tetap Bagus</Card.Title>
          <Card.Text>
            Gelandang tim nasional (timnas) Indonesia U-23, Sani Riski Fauzi,
            menegaskan kesiapannya untuk bermain pada laga melawan Brunei Darrussalam
